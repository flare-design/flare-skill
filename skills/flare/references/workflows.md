...
3. Identify `projectId` from the project URL, an explicit user-provided id, or the project selected through the Project Selection Pattern in `SKILL.md`. When operating in a browser-capable client, open the direct `projectUrl` before visible edits; do not navigate through the project list page.
...
1. Identify `projectId` from the project URL, an explicit user-provided id, or the project selected through the Project Selection Pattern in `SKILL.md`. When operating in a browser-capable client, open the direct `projectUrl` before visible edits; do not navigate through the project list page.
